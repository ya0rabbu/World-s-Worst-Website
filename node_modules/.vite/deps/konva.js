...
var Line = class extends Shape {
  ...
  getSelfRect() {
    ...
    if (this._hasTension()) {
      ...
      this._eachTensionSegment((x0, y0, cpx, cpy, x2, y2) => bounds.push(x2, y2, ...getQuadraticExtremaPoints(x0, y0, cpx, cpy, x2, y2)), (x0, y0, cp1x, cp1y, cp2x, cp2y, x2, y2) => bounds.push(x2, y2, ...getCubicExtremaPoints(x0, y0, cp1x, cp1y, cp2x, cp2y, x2, y2)));
      points = bounds;
    } else if (this.bezier()) {
